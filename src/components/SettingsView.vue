        ...
        <div class="erag-sync-row">
          <div class="erag-sync-info">
            <svg class="erag-sync-logo" viewBox="0 0 24 24">
              <path
                fill="#EA4335"
                d="M12 5.04c1.78 0 3.39.61 4.65 1.8l3.48-3.48C17.98 1.19 15.22 0 12 0 7.31 0 3.25 2.69 1.25 6.63l4.08 3.16c.96-2.88 3.66-4.75 6.67-4.75z"
              />
              <path
                fill="#4285F4"
              ...
              <path
                fill="#FBBC05"
                d="M5.33 14.78a7.12 7.12 0 0 1 0-4.56L1.25 7.06a11.96 11.96 0 0 0 0 9.88l4.08-3.16z"
              />
              <path
                fill="#34A853"
                d="M12 23.04c3.24 0 5.97-1.07 7.96-2.92l-3.66-2.84c-1.01.68-2.31 1.08-4.3 1.08-3.01 0-5.71-1.88-6.67-4.75L1.25 16.77c2 3.94 6.06 6.27 10.75 6.27z"
              />
            </svg>
    ...
    <div class="erag-settings-section">
      <div class="erag-impexp-container">
        ...
        <div class="erag-impexp-box">
          ...
          <p class="erag-impexp-desc">
            Upload event data files (.ics or .json) to load them into the calendar.
          </p>
        ...
        <div class="erag-impexp-box">
          ...
          <p class="erag-impexp-desc">
            Download all your calendar events to backup or migrate your data.
          </p>
          <button type="button" class="erag-btn" @click="handleExport">Export</button>
        </div>
      </div>
    </div>
  </div>
